      ...
      <div className="league-container">
         ...
         <div className="league__container-main">
            <ul className="league--sidebar">
               ...
               <li>
                  <button onClick={() => handleClick("Players")} className={activeTab === "Players" ? "active" : ""}>
                     Players
                  </button>
               </li>
               <li>
               ...
               <li>
                  <button onClick={() => handleClick("Matches")} className={activeTab === "Matches" ? "active" : ""}>
                     Matches
                  </button>
               </li>
               <li>
                  <button
                     onClick={() => handleClick("Team Info")}
                     className={activeTab === "Team Info" ? "active" : ""}>
                     Teams
                  </button>
               </li>
               <li>
                  <button onClick={() => handleClick("About")} className={activeTab === "About" ? "active" : ""}>
                     About
                  </button>
               </li>
            </ul>

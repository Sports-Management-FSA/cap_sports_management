   ...
   return (
      <div className="home-container">
         <div className="home-popular" >
            ...
            <div className="home-popular-cards">
               {topCategories.map((category)=>(
                //   <button className="home-popular-card" onClick={handleClick} value={category.name} key={category.id}>{category.name}</button>
                <div className="home-popular-card" onClick={handleClick} value={category.name} key={category.id}>
                    <a id="top">{category.name}</a>
                </div>
               ))}
            </div>
         </div>
         <div className="home-leagues">
            ...
            <div className="home-leagues-container" key={category.id}>

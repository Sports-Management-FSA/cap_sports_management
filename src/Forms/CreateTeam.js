   ...
   return (
      <div className="form__createteam">
         ...
         <form onSubmit={handleSubmit}>
            ...
            <input name="teamName" value={teamName} onChange={handleTeamNameChange} placeholder="enter a team name" />
            <label>Email</label>
            <input name="teamEmail" value={teamEmail} onChange={handleEmailChange} placeholder="email address" />
